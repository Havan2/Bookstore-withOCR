    ...
    <div className="App">
      ...
      <div className = "CenterScreen">
        <div className="about-us-content">
          <p>Welcome to Bookworm, your premier destination for exchanging books with fellow book lovers! Our platform was created with the vision of fostering a community of avid readers who share a passion for literature and learning.</p>
